<?php
/**
 * File for ChronopostWsdlClass to communicate with SOAP service
 * @package Chronopost
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @date 2013-05-16
 */
/**
 * ChronopostWsdlClass to communicate with SOAP service
 * 
 * @package Chronopost
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @date 2013-05-16
 */
class ChronopostWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses ChronopostWsdlClass::setLastError()
	 * @uses ChronopostWsdlClass::initSoapClient()
	 * @uses ChronopostWsdlClass::initInternArrayToIterate()
	 * @uses ChronopostWsdlClass::_set()
	 ...
	 * @return ChronopostWsdlClass|null
	 */
	 ...
	 * @uses ChronopostClassMap::classMap()
	 * @uses ChronopostWsdlClass::getDefaultWsdlOptions()
	 * @uses ChronopostWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('ChronopostClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = ChronopostClassMap::classMap();
	 ...
	 * @uses ChronopostWsdlClass::WSDL_CACHE_WSDL
	 * @uses ChronopostWsdlClass::WSDL_COMPRESSION
	 * @uses ChronopostWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses ChronopostWsdlClass::WSDL_ENCODING
	 * @uses ChronopostWsdlClass::WSDL_EXCPTS
	 * @uses ChronopostWsdlClass::WSDL_FEATURES
	 * @uses ChronopostWsdlClass::WSDL_LOGIN
	 * @uses ChronopostWsdlClass::WSDL_PASSWD
	 * @uses ChronopostWsdlClass::WSDL_SOAP_VERSION
	 * @uses ChronopostWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses ChronopostWsdlClass::WSDL_TRACE
	 * @uses ChronopostWsdlClass::WSDL_TYPEMAP
	 * @uses ChronopostWsdlClass::WSDL_URL
	 * @uses ChronopostWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses ChronopostWsdlClass::getSoapClient()
	 * @uses ChronopostWsdlClass::getFormatedXml()
	 ...
	 * @uses ChronopostWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses ChronopostWsdlClass::getInternArrayToIterate()
	 * @uses ChronopostWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses ChronopostWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses ChronopostWsdlClass::getInternArrayToIterateOffset()
	 * @uses ChronopostWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses ChronopostWsdlClass::getInternArrayToIterateOffset()
	 * @uses ChronopostWsdlClass::offsetExists()
	 ...
	 * @see ChronopostWsdlClass::offsetGet()
	 * @uses ChronopostWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses ChronopostWsdlClass::getAttributeName()
	 * @uses ChronopostWsdlClass::__toString()
	 * @uses ChronopostWsdlClass::_set()
	 * @uses ChronopostWsdlClass::_get()
	 * @uses ChronopostWsdlClass::setInternArrayToIterate()
	 * @uses ChronopostWsdlClass::setInternArrayToIterateIsArray()
	 * @uses ChronopostWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses ChronopostWsdlClass::item()
	 * @uses ChronopostWsdlClass::length()
	 * @return mixed
	 */
