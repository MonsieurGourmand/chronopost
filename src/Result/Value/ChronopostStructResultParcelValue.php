<?php
/**
 * File for class ChronopostStructResultParcelValue
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructResultParcelValue originally named resultParcelValue
 ...
 * @date 2013-05-16
 */
class ChronopostStructResultParcelValue extends ChronopostWsdlClass
{
	/**
	 * The codeDepot
	 * Meta informations extracted from the WSDL
	 ...
	 */
	public function __construct($_codeDepot = NULL,$_codeService = NULL,$_dSort = NULL,$_destinationDepot = NULL,$_geoPostCodeBarre = NULL,$_geoPostNumeroColis = NULL,$_groupingPriorityLabel = NULL,$_oSort = NULL,$_reservationNumber = NULL,$_serviceMark = NULL,$_serviceName = NULL,$_signaletiqueProduit = NULL,$_skybillNumber = NULL)
	{
		parent::__construct(array('codeDepot'=>$_codeDepot,'codeService'=>$_codeService,'DSort'=>$_dSort,'destinationDepot'=>$_destinationDepot,'geoPostCodeBarre'=>$_geoPostCodeBarre,'geoPostNumeroColis'=>$_geoPostNumeroColis,'groupingPriorityLabel'=>$_groupingPriorityLabel,'OSort'=>$_oSort,'reservationNumber'=>$_reservationNumber,'serviceMark'=>$_serviceMark,'serviceName'=>$_serviceName,'signaletiqueProduit'=>$_signaletiqueProduit,'skybillNumber'=>$_skybillNumber));
	}
	/**
	 * Get codeDepot value
	 * @return string|null
