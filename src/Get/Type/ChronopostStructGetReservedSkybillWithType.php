<?php
/**
 * File for class ChronopostStructGetReservedSkybillWithType
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructGetReservedSkybillWithType originally named getReservedSkybillWithType
 ...
 * @date 2013-05-16
 */
class ChronopostStructGetReservedSkybillWithType extends ChronopostWsdlClass
{
	/**
	 ...
	 * @return ChronopostStructGetReservedSkybillWithType
	 */
