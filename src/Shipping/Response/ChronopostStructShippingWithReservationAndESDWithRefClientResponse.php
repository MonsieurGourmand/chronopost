<?php
/**
 * File for class ChronopostStructShippingWithReservationAndESDWithRefClientResponse
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructShippingWithReservationAndESDWithRefClientResponse originally named shippingWithReservationAndESDWithRefClientResponse
 ...
 * @date 2013-05-16
 */
class ChronopostStructShippingWithReservationAndESDWithRefClientResponse extends ChronopostWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
