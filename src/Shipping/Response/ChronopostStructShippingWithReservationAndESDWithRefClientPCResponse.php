<?php
/**
 * File for class ChronopostStructShippingWithReservationAndESDWithRefClientPCResponse
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructShippingWithReservationAndESDWithRefClientPCResponse originally named shippingWithReservationAndESDWithRefClientPCResponse
 ...
 * @date 2013-05-16
 */
class ChronopostStructShippingWithReservationAndESDWithRefClientPCResponse extends ChronopostWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
