<?php
/**
 * File for class ChronopostStructShippingWithReservation
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructShippingWithReservation originally named shippingWithReservation
 ...
 * @date 2013-05-16
 */
class ChronopostStructShippingWithReservation extends ChronopostWsdlClass
{
	/**
	 * The esdValue
	 * Meta informations extracted from the WSDL
	 ...
	 * @return ChronopostStructShippingWithReservation
	 */
