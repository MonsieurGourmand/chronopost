<?php
/**
 * File for class ChronopostStructShipping
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructShipping originally named shipping
 ...
 * @date 2013-05-16
 */
class ChronopostStructShipping extends ChronopostWsdlClass
{
	/**
	 * The esdValue
	 * Meta informations extracted from the WSDL
	 * - minOccurs : 0
	 * @var ChronopostStructEsdValue
	 */
	public $esdValue;
	/**
	 * The headerValue
	 ...
	 * @param ChronopostStructEsdValue $_esdValue
	 ...
	 * @return ChronopostStructShipping
	 */
	public function __construct($_esdValue = NULL,$_headerValue = NULL,$_shipperValue = NULL,$_customerValue = NULL,$_recipientValue = NULL,$_refValue = NULL,$_skybillValue = NULL,$_skybillParamsValue = NULL,$_password = NULL)
	{
		parent::__construct(array('esdValue'=>$_esdValue,'headerValue'=>$_headerValue,'shipperValue'=>$_shipperValue,'customerValue'=>$_customerValue,'recipientValue'=>$_recipientValue,'refValue'=>$_refValue,'skybillValue'=>$_skybillValue,'skybillParamsValue'=>$_skybillParamsValue,'password'=>$_password));
	}
	/**
	 * Get esdValue value
	 * @return ChronopostStructEsdValue|null
	 */
	...
	/**
	 * Set esdValue value
	 * @param ChronopostStructEsdValue $_esdValue the esdValue
