<?php
/**
 * File for class ChronopostStructShippingWithReservationAndESDWithRefClient
 * @package Chronopost
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ChronopostStructShippingWithReservationAndESDWithRefClient originally named shippingWithReservationAndESDWithRefClient
 ...
 * @date 2013-05-16
 */
class ChronopostStructShippingWithReservationAndESDWithRefClient extends ChronopostWsdlClass
{
	/**
	 * The esdValue
	 * Meta informations extracted from the WSDL
	 ...
	 * @return ChronopostStructShippingWithReservationAndESDWithRefClient
	 */
